...
RETURN (SELECT COUNT(*) 
      ...
      WHERE (C.CLIENTE_NOMBRE = @NOMBRE AND C.CLIENTE_APELLIDO = @APELLIDO)
       OR (C.CLIENTE_ID_TIPO_DOC = @TIPO_IDENT AND C.CLIENTE_DOC = @NRO_IDENT)
...
END
 ...
 SET @CODIGO_GEN = CONTROL_ZETA.FN_EXISTE_CLIENTE(@TIPO_IDENT, @NRO_IDENT, @EMAIL, @NOMBRE, @APELLIDO)
...
ELSE 
BEGIN
 SET @CODIGO = 1 -- ALTA DE USUARIO EXISTENTE
END
...
ELSE
BEGIN
  SET @CODIGO = 3 -- BAJA DE CLIENTE INEXISTENTE
END
