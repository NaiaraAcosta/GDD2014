...
SELECT @TOTAL_ESTADIA = DATEDIFF (DAY,R.RESERVA_FECHA_INICIO,R.RESERVA_FECHA_HASTA) *
       ((RG.REG_PRECIO *  TH.TIPO_HAB_PORC  ) +
       (HT.HOTEL_RECARGA_ESTRELLA * HT.HOTEL_CANT_ESTRELLA) ) AS TOTAL_ESTADIA,
        @ESTADIA_ID = E.EST_ID, 
...
WHERE R.RESERVA_ID = 10041
  ...
  AND R.RESERVA_ID = RH.RESERVA_ID
  AND RH.HAB_ID = H.HAB_ID
  AND H.HAB_ID_TIPO = TH.TIPO_HAB_ID
  AND R.RESERVA_ID_HOTEL = HT.HOTEL_ID


SET @NRO_FACT = CONTROL_ZETA.FN_BUSCA_FACTURA(); 

INSERT INTO CONTROL_ZETA.FACTURA (FACTURA_NRO, FACTURA_FECHA,FACTURA_FORMA_PAGO,FACTURA_NRO_TARJETA, FACTURA_COD_VERIFICADOR, EST_ID)
VALUES
