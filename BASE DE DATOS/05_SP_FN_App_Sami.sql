...
GO
DROP PROCEDURE CONTROL_ZETA.SP_REGISTRAR_ESTADIA
GO
...
DROP FUNCTION CONTROL_ZETA.FN_BUSCA_FACTURA
GO
...
GO
DROP PROCEDURE CONTROL_ZETA.SP_REALIZAR_FACTURACION
GO
...
VALUES
(@NRO_FACT, GETDATE(),@FORMAPAGO,@NROTARJETA,@COD_VERIF,@ESTADIA_ID, @FECHA_VENC, @NRO_CUOTAS,@ID_CLIENTE)
...
DROP PROCEDURE CONTROL_ZETA.SP_ESTADISTICAS
