...
--SELECT * FROM CONTROL_ZETA.RESERVA


-- no tiene sentido el manejo de estado
...
INSERT INTO CONTROL_ZETA.ITEM_FACTURA 
 ...
 (SELECT  M.FACTURA_NRO, M.ITEM_FACTURA_CANTIDAD ITEM_FACTURA_CANTIDAD, 
          M.ITEM_FACTURA_MONTO * M.Reserva_Cant_Noches, 'COSTO POR REGIMEN' 
 FROM GD_ESQUEMA.MAESTRA M
 ...
 AND Consumible_Codigo IS  NULL --and factura_nro = 2396782
  UNION all
 SELECT  M.FACTURA_NRO,  COUNT(*) ITEM_FACTURA_CANTIDAD, 
...
GO*/
 UPDATE CONTROL_ZETA.RESERVA 
 SET CONTROL_ZETA.RESERVA.RES_PRECIO_TOTAL = M.REGIMEN_PRECIO * M.HABITACION_TIPO_PORCENTUAL * 
                                             TH.TIPO_HAB_CANT_PERSONAS 
                                             + M.HOTEL_RECARGA_ESTRELLA * M.HOTEL_CANTESTRELLA
 FROM CONTROL_ZETA.RESERVA R
  INNER JOIN GD_ESQUEMA.MAESTRA M ON M.RESERVA_CODIGO = R.RESERVA_ID
  INNER JOIN CONTROL_ZETA.TIPO_HAB TH ON TH.TIPO_HAB_ID = M.HABITACION_TIPO_CODIGO
  WHERE R.RESERVA_ESTADO = 'RI'  
  --AND   R.RESERVA_ID = 57158  
