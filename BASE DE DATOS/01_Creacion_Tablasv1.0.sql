...
(USR_USERNAME VARCHAR(50) not NULL,
USR_PASS VARCHAR (70) not NULL,---Cambie el tipo porque se va a poner el encriptado ahi 
...
--HOTEL_ID_CIUDAD  TINYINT, --Como ciudad es lo mismo que localidad se modifico el nombre y se agrego contraint 
...
(ITEM_FACTURA_NRO SMALLINT identity(1,1) not NULL,
FACTURA_NRO NUMERIC not NULL,
...
(EST_ID numeric  not NULL,
 ...
 CON_ID SMALLINT NOT NULL,
--CONSTRAINT PK_EST_HAB_CON PRIMARY KEY(EST_ID, HAB_ID),
